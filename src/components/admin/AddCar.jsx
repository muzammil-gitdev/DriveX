...
const AddCar = () => {
    ...
    const carData = location.state?.carData || null; // received from ManageCars edit button
    ...
    return (
        <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-gray-800 mb-6">{carData ? "Edit Car" : "Add New Car"}</h2>
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div>
                        ...
                        <div className="flex items-center justify-center w-full">
                            ...
                            {/* Show previous image preview if editing */}
                    ...
                    <div className="flex justify-end">
                        <button
                            type="button"
                            className="px-6 py-2 bg-gray-200 text-gray-700 rounded-lg mr-4 hover:bg-gray-300"
                        >
                            Cancel
                        </button>
                        <button
